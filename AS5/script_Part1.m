...
figure(1);
subplot(1,2,1);imshow(im1);title('IMG\_5030.JPG');
subplot(1,2,2);imshow(im2);title('IMG\_5031.JPG');
...
figure(2);
imshow(im_square1);
title('IMG\_5030.JPG Feature Detection Window Size=9');
figure(3);
imshow(im_square2);
title('IMG\_5031.JPG Feature Detection Window Size=9');
%%%%%%%%%%%%%%%%%%%%%%%%%%Problem 1
cor_thre=0.7;
dis_thre=0.95;
window_size2=11;
...
subplot(1,2,1);
imshow(im_square11);
title('Feature matched in IMG\_5030.JPG with Proximity Window ');
subplot(1,2,2);
imshow(im_square22);
title('Feature matched in IMG\_5031.JPG with Proximity Window ');
%%%%%%%%%%%%%%%%%%%%%%%%%%%Problem 2
